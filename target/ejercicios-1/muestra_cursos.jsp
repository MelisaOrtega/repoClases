    ...
    <body>
        ...
        <ul>
            <%
                ...
                String consulta1 = "SELECT * FROM tb_curs";
                ...
                try {
                    ...
                    while (listaCursos.next()) {
                        String color;
                        int cant = Integer.parseInt(listaCursos.getString("inscriptos"));
                        if (cant < 15){
                            color="green";                    
                        ...
                        out.println("detalle: " + listaCursos.getString("desc_curs_corto") + "</br>");
                        out.println("inscriptos: " + cant + "</br>");
                        out.println("<a href='infocurso_carga.jsp?curso=" + listaCursos.getString("id_curs") + "'>IR AL CURSO</a>");
                    }
